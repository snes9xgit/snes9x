...
INT_PTR CALLBACK DlgSoundConf(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	switch(msg)
	{
	    case WM_INITDIALOG:
        {
			...
			CreateToolTip(IDC_SLIDER_VOLUME_REGULAR, hDlg, SNDSET_VOLUME_REGULAR);
			CreateToolTip(IDC_EDIT_VOLUME_REGULAR, hDlg, SNDSET_VOLUME_REGULAR);
			CreateToolTip(IDC_SLIDER_VOLUME_TURBO, hDlg, SNDSET_VOLUME_TURBO);
			CreateToolTip(IDC_EDIT_VOLUME_TURBO, hDlg, SNDSET_VOLUME_TURBO);
			CreateToolTip(IDC_OUTPUT_DEVICE, hDlg, SNDSET_OUTPUT_DEVICE);
			CreateToolTip(IDC_RATE, hDlg, SNDSET_RATE);
            CreateToolTip(IDC_INRATEEDIT, hDlg, SNDSET_INRATE);
            CreateToolTip(IDC_INRATE, hDlg, SNDSET_INRATE);
            CreateToolTip(IDC_DYNRATECONTROL, hDlg, SNDSET_DYNRATECONTROL);
...
INT_PTR CALLBACK DlgFunky(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_INITDIALOG:
    {
		...
		CreateToolTip(IDC_OUTPUTMETHOD, hDlg, DSPSET_OUTPUTMETHOD);
		CreateToolTip(IDC_FULLSCREEN, hDlg, DSPSET_FULLSCREEN);
		CreateToolTip(IDC_FULLSCREEN_ON_OPEN, hDlg, DSPSET_FULLSCREEN_ON_OPEN);
        CreateToolTip(IDC_EMUFULLSCREEN, hDlg, DSPSET_EMUFULLSCREEN);
		CreateToolTip(IDC_STRETCH, hDlg, DSPSET_STRETCH);
        CreateToolTip(IDC_AUTOFRAME, hDlg, DSPSET_AUTOFRAME);
        CreateToolTip(IDC_MAXSKIP, hDlg, DSPSET_AUTOFRAME);
        CreateToolTip(IDC_FIXEDSKIP, hDlg, DSPSET_FIXEDSKIP);
        CreateToolTip(IDC_SKIPCOUNT, hDlg, DSPSET_FIXEDSKIP);
        CreateToolTip(IDC_HIRES, hDlg, DSPSET_HIRES);
        CreateToolTip(IDC_HEIGHT_EXTEND, hDlg, DSPSET_HEIGHT_EXTEND);
        CreateToolTip(IDC_MESSAGES_IN_IMAGE, hDlg, DSPSET_MESSAGES_IN_IMAGE);
		CreateToolTip(IDC_MESSAGES_SCALE, hDlg, DSPSET_MESSAGES_SCALE);
