...
#define CATEGORY "Display\\Win"
	...
	AddBoolC("Window:WriteIconToExe", GUI.ExeIconRewriteOK, false, "true once the user agreed to also write the chosen logo into the .exe file icon (File > Choose Logo)");
